...
const user_Assessments = require('./routes/user_Assessments');
const user_answers = require('./routes/user_answers');
const questions = require('./routes/questions');
const error = require('./middleware/error');

app.get('/api', (req, res) => {
  const url = "https://github.com/mustafizur118/Assessments-api";
...
app.use('/api/Assessments', Assessments);
  app.use('/api/Assessments', questions); // questions is nested
app.use('/api/user-Assessments', user_Assessments);
  app.use('/api/user-Assessments', user_answers); // user-answers is nested
